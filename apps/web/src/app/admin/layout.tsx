...
const ADMIN_NAV = [
  { href: "/admin/users", label: "Users & Providers", icon: Users },
  { href: "/admin/audit", label: "HIPAA PHI Audit Trail", icon: FileSearch },
];
      ...
      <aside className="hidden md:flex w-64 flex-col border-r border-[var(--line)] bg-[var(--paper-raised)] p-4 justify-between shadow-xs">
        <div className="space-y-6">
          ...
          <div className="px-3 py-2 rounded border border-[var(--line)] bg-[var(--paper-sunken)] flex items-center justify-between font-mono text-[11px]">
            <span className="text-[var(--ink-muted)] uppercase tracking-wider">ADMIN LEDGER</span>
            <span className="flex items-center gap-1.5 text-indigo-400 font-semibold text-[10px]">
        ...
        <div className="border-t border-[var(--line)] pt-4 space-y-2">
          <div className="flex items-center gap-3 px-2 py-1 text-xs text-[var(--ink-muted)]">
            ...
            <div>
              <p className="font-semibold text-[var(--ink)]">System Administrator</p>
              <p className="font-mono text-[10px] text-[var(--ink-faint)]">Org: Nuvi Health Core</p>
            </div>
          </div>
          <Link href="/signin">
